# FICHE BUILD — Exercice Builder
*Generee automatiquement par MOAT Build Index*
*Date : 2026-04-10*
*BRI : 83.2/100 — FICHE BUILD AUTO*
...
|-----------|-------|-----|--------|
| Potentiel marche (MOAT) | 20.2 | 25 | Score MOAT 81/100 |
...
| **TOTAL BRI** | **83.2** | **100** | **FICHE BUILD AUTO** |

## Identite

- **Segment** : Kines/coachs independants
- **Monetisation** : Abonnement ~7.99/mois
...
1. `flutter create --org com.xxx exercicebuilder`
